...
w2_2=w2_2+eta*e*y2_1;
w3_2=w3_2+eta*e*y3_1;
w4_2=w4_2+eta*e*y4_1;

b=b+eta*e*1;

delta1=v1_1*(1-v1_1)*e*w1_2;
delta2=v2_1*(1-v2_1)*e*w2_2;
delta3=v3_1*(1-v3_1)*e*w3_2;
delta4=v4_1*(1-v4_1)*e*w4_2;

w1_1=w1_1*eta*delta1*x;
w2_1=w2_1*eta*delta2*x; % ar cia palikti w1_1????
w3_1=w3_1*eta*delta3*x;
w4_1=w4_1*eta*delta4*x;
